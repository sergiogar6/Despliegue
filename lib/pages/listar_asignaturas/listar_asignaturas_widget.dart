...
class _ListarAsignaturasWidgetState extends State<ListarAsignaturasWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listaAsignaturas = await actions.getListaAsignaturas();
      _model.asignaturas = _model.listaAsignaturas!.toList().cast<dynamic>();
      safeSetState(() {});
    });
  }
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Builder(
                builder: (context) {
                  final listviewAsignaturas = _model.asignaturas.toList();
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                AlumnosAsignaturaWidget.routeName,
                                queryParameters: {
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                              ...
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text('ELIMINAR'),
                                                        content: Text(
                                                            'VAS A ELIMINAR LA ASIGNATURA SELECCIONADA. ESTAS SEGURO?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                          ...
                                          _model.listaAsignaturasAfterDelete =
                                              await actions
                                                  .getListaAsignaturas();
                                          _model.asignaturas = _model
                                              .listaAsignaturasAfterDelete!
                                              .toList()
                                              .cast<dynamic>();
                                          safeSetState(() {});
