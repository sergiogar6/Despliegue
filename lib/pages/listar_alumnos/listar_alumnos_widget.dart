...
class _ListarAlumnosWidgetState extends State<ListarAlumnosWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listaAlumnos = await actions.getListaAlumnos();
      _model.alumnos = _model.listaAlumnos!.toList().cast<dynamic>();
      safeSetState(() {});
    });
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    final listaAlumnos = _model.alumnos.toList();
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, listaAlumnosIndex) {
                        final listaAlumnosItem =
                            listaAlumnos[listaAlumnosIndex];
                        return Padding(
                                          ...
                                          onPressed: () async {
                                            var confirmDialogResponse =
                                                await showDialog<bool>(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title:
                                                              Text('ELIMINAR'),
                                                          content: Text(
                                                              'VAS A ELIMINAR AL ALUMNO SELECCIONADO. ESTAS SEGURO?'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                                    ...
                                                    false;
                                            await actions.deleteAlumno(
                                              getJsonField(
                                                listaAlumnosItem,
                                                r'''$.id''',
                                              ),
                                            );
                                            _model.listaAlumnosAfterDelete =
                                                await actions.getListaAlumnos();
                                            _model.alumnos = _model
                                                .listaAlumnosAfterDelete!
                                                .toList()
                                                .cast<dynamic>();
                                            safeSetState(() {});
